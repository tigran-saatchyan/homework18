    ...
    movies = [
        {
            ...
            'description': "An orphaned boy enrolls in a school of wizardry, "
                           "where he learns the truth about himself, his family "
        ...
        },
        {
            ...
            'description': "An ancient prophecy seems to be coming true when a "
                           "mysterious presence begins stalking the corridors of "
                           "a school of magic and leaving its victims paralyzed.",
...

        {
            ...
            'description': "Harry Potter, Ron and Hermione return to Hogwarts "
                           "School of Witchcraft and Wizardry for their third year of study, where they delve into the mystery surrounding an escaped prisoner who poses a dangerous threat to the young wizard.",
...

        {
            ...
            'description': "Harry Potter finds himself competing in a hazardous "
...

        {
            ...
            'description': "WITH their warning about Lord Voldemort's return "
                           "scoffed at, Harry and Dumbledore are targeted by the "
                           "Wizard authorities as an authoritarian bureaucrat "
                           "slowly seizes power at Hogwarts.",
...

        {
            ...
            'description': "As Harry Potter begins his sixth year at Hogwarts, "
                           "he discovers an old book marked as 'the property of "
                           "the Half-Blood Prince' and begins to learn more "
...

        {
            ...
            'description': "Harry, Ron, and Hermione search for Voldemort's "
                           "remaining Horcruxes in their effort to destroy the "
                           "Dark Lord as the final battle rages on at Hogwarts.",
